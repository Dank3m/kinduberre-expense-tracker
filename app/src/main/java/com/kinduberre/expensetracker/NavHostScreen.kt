            ...
            AnimatedVisibility(visible = bottomBarVisibility){
                NavigationBottomBar(
                    ...
                    items = listOf(
                        NavItem(
                            route = "/home",
                            icon = com.kinduberre.expensetracker.R.drawable.ic_home
                        ),
                        NavItem(
                            route = "/add",
                            icon = com.kinduberre.expensetracker.R.drawable.ic_add),
                        NavItem(
                            route = "/stats",
                            icon = com.kinduberre.expensetracker.R.drawable.ic_stats
                        )
                    )
                )
            }
